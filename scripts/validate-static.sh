...
require_contains "api.log-fields" include/mp_logger.h "mp_logger_log_fields(" "public header exposes structured log API"
...
require_comment_before "comment.header.log-fields" include/mp_logger.h 'mp_log_status_t mp_logger_log_fields(' "public header documents structured enqueue semantics"
...
require_comment_before "comment.go.log-fields" bindings/go/logger.go 'func (logger *Logger) LogFields(' "Go wrapper documents structured enqueue semantics"
